...
# SECRET_KEY = 'django-insecure-!4-n(!t-pg$#&osfs^^8vs&h6l&#4f$0$lceo__hhmiryg_8a1'
...
DATABASES = {
    'default': dj_database_url.config(
        default="postgresql://postgres:A@mosh4postgres@localhost:5432/payout_db"
    )
}
